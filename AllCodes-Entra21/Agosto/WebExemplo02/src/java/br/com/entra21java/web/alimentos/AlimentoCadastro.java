...
public class AlimentoCadastro extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("<input type='text' id='campo-nome' name='nome' class='form-control' onfocusout='validarCampoNome()' required='required'>");
        out.println("</div>");
        ...
        out.println("<input type='text' id='campo-quantidade' name='quantidade' class='form-control' onfocusout='validarCampoQuantidade()' required='required'>");
        out.println("</div>");
        ...
        out.println("<input type='text' id='campo-preco' name='preco' class='form-control' onfocusout='validarCampoPreco()' required='required'>");
        out.println("</div>");
        out.println("<div class='form-group'>");
        out.println("<label for='campo-descricao'>Descrição</label>");
        out.println("<textarea id='campo-descricao' name='descricao' class='form-control'></textarea>");
        out.println("</div>");
        out.println("<input type='submit' value='Cadastrar' class='btn btn-primary'>");
        out.println("</form>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
